...
T = TypeVar("T", bound="AddTradovateSubscription")


@attr.s(auto_attribs=True)
class AddTradovateSubscription:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_tradovate_subscription = cls(
        ...
        add_tradovate_subscription.additional_properties = d
        return add_tradovate_subscription
