...
T = TypeVar("T", bound="CancelSecondMarketDataSubscriptionRenewal")


@attr.s(auto_attribs=True)
class CancelSecondMarketDataSubscriptionRenewal:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cancel_second_market_data_subscription_renewal = cls(
            second_market_data_subscription_id=second_market_data_subscription_id,
        )

        cancel_second_market_data_subscription_renewal.additional_properties = d
        return cancel_second_market_data_subscription_renewal
