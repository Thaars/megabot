...
T = TypeVar("T", bound="AddSecondMarketDataSubscription")


@attr.s(auto_attribs=True)
class AddSecondMarketDataSubscription:
    """
    Attributes:
        year (int):
        month (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_second_market_data_subscription = cls(
            year=year,
            month=month,
        ...
        add_second_market_data_subscription.additional_properties = d
        return add_second_market_data_subscription
