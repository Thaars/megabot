...
from ..models.place_oso_action import PlaceOSOAction
from ..models.place_oso_order_type import PlaceOSOOrderType
from ..models.place_oso_time_in_force import PlaceOSOTimeInForce
from ..models.restrained_order_version import RestrainedOrderVersion
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlaceOSO")
...
class PlaceOSO:
    """
    Attributes:
        action (PlaceOSOAction): Buy, Sell
        symbol (str):
        order_qty (int):
        order_type (PlaceOSOOrderType): Limit, MIT, Market, QTS, Stop, StopLimit, TrailingStop, TrailingStopLimit
        ...
        time_in_force (Union[Unset, PlaceOSOTimeInForce]): Day, FOK, GTC, GTD, IOC
        ...
        bracket2 (Union[Unset, RestrainedOrderVersion]):
    """
    ...
    time_in_force: Union[Unset, PlaceOSOTimeInForce] = UNSET
    ...
    bracket2: Union[Unset, RestrainedOrderVersion] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        bracket1 = self.bracket1.to_dict()
        ...
        bracket2: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.bracket2, Unset):
            bracket2 = self.bracket2.to_dict()
        ...
        if bracket2 is not UNSET:
            field_dict["bracket2"] = bracket2
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        action = PlaceOSOAction(d.pop("action"))

        symbol = d.pop("symbol")

        order_qty = d.pop("orderQty")

        order_type = PlaceOSOOrderType(d.pop("orderType"))

        bracket1 = RestrainedOrderVersion.from_dict(d.pop("bracket1"))
        ...
        time_in_force: Union[Unset, PlaceOSOTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = PlaceOSOTimeInForce(_time_in_force)
        ...
        _bracket2 = d.pop("bracket2", UNSET)
        bracket2: Union[Unset, RestrainedOrderVersion]
        if isinstance(_bracket2, Unset):
            bracket2 = UNSET
        else:
            bracket2 = RestrainedOrderVersion.from_dict(_bracket2)
        ...
        place_oso.additional_properties = d
        return place_oso
