...
T = TypeVar("T", bound="AcceptTradingPermission")


@attr.s(auto_attribs=True)
class AcceptTradingPermission:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accept_trading_permission = cls(
            trading_permission_id=trading_permission_id,
        )

        accept_trading_permission.additional_properties = d
        return accept_trading_permission
