...
from ..models.place_oco_action import PlaceOCOAction
from ..models.place_oco_order_type import PlaceOCOOrderType
from ..models.place_oco_time_in_force import PlaceOCOTimeInForce
from ..models.restrained_order_version import RestrainedOrderVersion
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlaceOCO")
...
class PlaceOCO:
    """
    Attributes:
        action (PlaceOCOAction): Buy, Sell
        symbol (str):
        order_qty (int):
        order_type (PlaceOCOOrderType): Limit, MIT, Market, QTS, Stop, StopLimit, TrailingStop, TrailingStopLimit
        ...
        time_in_force (Union[Unset, PlaceOCOTimeInForce]): Day, FOK, GTC, GTD, IOC
    ...
    time_in_force: Union[Unset, PlaceOCOTimeInForce] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        action = PlaceOCOAction(d.pop("action"))

        symbol = d.pop("symbol")

        order_qty = d.pop("orderQty")

        order_type = PlaceOCOOrderType(d.pop("orderType"))

        other = RestrainedOrderVersion.from_dict(d.pop("other"))
        ...
        time_in_force: Union[Unset, PlaceOCOTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = PlaceOCOTimeInForce(_time_in_force)
        ...
        place_oco.additional_properties = d
        return place_oco
