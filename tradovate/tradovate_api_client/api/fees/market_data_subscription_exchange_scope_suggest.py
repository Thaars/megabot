...
def _get_kwargs(
    *,
    ...
    url = "{}/marketDataSubscriptionExchangeScope/suggest".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Retrieves entities of MarketDataSubscriptionExchangeScope type filtered by an occurrence of a text
