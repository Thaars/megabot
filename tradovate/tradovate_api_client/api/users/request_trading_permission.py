...
from ...models.request_trading_permission import RequestTradingPermission
...
def _get_kwargs(
    *,
    ...
    json_body: RequestTradingPermission,
) -> Dict[str, Any]:
    url = "{}/user/requesttradingpermission".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Once this request is reviewed by our accounting and compliance, the other party will be allowed to
    access your account as if it was one of that party's own accounts.
