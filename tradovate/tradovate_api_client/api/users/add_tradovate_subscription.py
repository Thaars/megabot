...
from ...models.add_tradovate_subscription import AddTradovateSubscription
...
def _get_kwargs(
    *,
    ...
    json_body: AddTradovateSubscription,
) -> Dict[str, Any]:
    url = "{}/user/addtradovatesubscription".format(client.base_url)
