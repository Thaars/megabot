...
from ...models.cancel_second_market_data_subscription import CancelSecondMarketDataSubscription
...
def _get_kwargs(
    *,
    ...
    json_body: CancelSecondMarketDataSubscription,
) -> Dict[str, Any]:
    url = "{}/user/cancelsecondmarketdatasubscription".format(client.base_url)
