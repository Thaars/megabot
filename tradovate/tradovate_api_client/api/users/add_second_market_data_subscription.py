...
from ...models.add_second_market_data_subscription import AddSecondMarketDataSubscription
...
def _get_kwargs(
    *,
    ...
    json_body: AddSecondMarketDataSubscription,
) -> Dict[str, Any]:
    url = "{}/user/addsecondmarketdatasubscription".format(client.base_url)
