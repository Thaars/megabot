...
def _get_kwargs(
    *,
    ...
    url = "{}/currencyRate/ldeps".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[CurrencyRate]]:
...
def _build_response(*, response: httpx.Response) -> Response[List[CurrencyRate]]:
    return Response(
