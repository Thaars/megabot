...
from ...models.interrupt_order_strategy import InterruptOrderStrategy
...
def _get_kwargs(
    *,
    ...
    json_body: InterruptOrderStrategy,
) -> Dict[str, Any]:
    url = "{}/orderStrategy/interruptorderstrategy".format(client.base_url)
