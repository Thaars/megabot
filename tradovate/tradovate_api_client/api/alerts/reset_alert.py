...
from ...models.reset_alert import ResetAlert
...
def _get_kwargs(
    *,
    ...
    json_body: ResetAlert,
) -> Dict[str, Any]:
    url = "{}/alert/resetalert".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """### Resets an alert.
    You can use this method after an alert has been triggered to keep the alert and wait for the alert
