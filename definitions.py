...
# <= 30 min: 0.03, 0.2
# 1-4h: 0.02, 0.2
PARABOLIC_SAR_ACCELERATION_FACTOR = 0.03
PARABOLIC_SAR_MAX_ACCELERATION_FACTOR = 0.2
# <= 30 min: 5 bis 10
# 1-4h: 20
VOLUME_SMA_PERIOD = 9
# <= 30 min: 6 bis 14
...
# <= 30 min: 7 bis 10
# 1-4h: 14
VORTEX_INDICATOR_PERIOD = 8
# <= 30 min: 8 bis 12
# 1-4h: 20
EMA_PERIOD = 20
# <= 30 min: beide 5 bis 10
# 1-4h: beide 10
CHAIKIN_VOLATILITY_EMA_PERIOD = 8
CHAIKIN_VOLATILITY_CHANGE_PERIOD = 8
# <= 30 min: 5, 13, 5
# 1-4h: 12, 26, 9
MACD_SHORT_PERIOD = 5
MACD_LONG_PERIOD = 13
...
# <= 30 min: 5 bis 10
# 1-4h: 10
HISTORICAL_VOLATILITY_PERIOD = 8
# <= 30 min: 5 bis 14
# 1-4h: 14
RSI_PERIOD = 10
# <= 30 min: 10 bis 12
# 1-4h: 20, 2
BOLLINGER_BANDS_PERIOD = 12
...
# <= 30 min: 5 bis 9
# 1-4h: 13
ELDERS_FORCE_INDEX_PERIOD = 9
# <= 30 min: 5 bis 10
# 1-4h: 14
DEMARKER_INDICATOR_PERIOD = 10
# <= 30 min: 10 bis 20
# 1-4h: 20 - 30
FIBONACCI_RETRACEMENTS_PERIOD = 15
# <= 30 min: 10, 5, 1.5
# 1-4h: 20, 10, 2
KELTNER_CHANNELS_EMA_PERIOD = 10
KELTNER_CHANNELS_ATR_PERIOD = 5
